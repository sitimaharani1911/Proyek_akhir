    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{route('pengajuan_dana.tambah')}}" type="button" class="btn btn-primary er fs-6 px-4 py-2">
        ...
        <div class="card mb-5 mb-xl-8">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Data Pengajuan Dana Kegiatan</span>
                </h3>
            </div>
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td><a href="{{ url('pengajuan-dana/show/id') }}">
                                        <i class="fa fa-eye text-info" style="margin-right: 10px;"></i>
                                    </a>
                                    <a href="{{ url('pengajuan-dana/edit/id') }}">
