                ...
                <div class="card-body py-3">
                    @forelse ($pelaporans as $pelaporan)
                        ...
                        @if ($monevs)
                            ...
                            @endif
                            <form class="row"
                                action="{{ route('monev.review.store', ['pelaporan_id' => $pelaporan->id]) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $pelaporan->tanggal }}"
                                            readonly />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3 group-catatan">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <label for="pengajuan-dana-terima" class="input-group-text">
                                                <input type="radio" id="pengajuan-dana-terima"
                                                    name="status_pengajuan_dana" value="Diterima" class="d-none" />
                                                <i class="bi bi-check-circle-fill"></i>
                                            </label>
                                            <label for="pengajuan-dana-tolak" class="input-group-text">
                                                <input type="radio" id="pengajuan-dana-tolak"
                                                    name="status_pengajuan_dana" value="Ditolak" class="d-none" />
                                    ...
                                    <div class="mb-3 group-catatan">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                value="{{ $pelaporan->sisa_dana }}" readonly />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 group-catatan">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                value="{{ $pelaporan->link_luaran }}" readonly />
                                            ...
                                            <label for="luaran-tolak" class="input-group-text">
                                                <input type="radio" id="luaran-tolak" name="status_luaran"
                                                    value="Ditolak" class="d-none" />
                                                <i class="bi bi-x-circle-fill"></i>
                                            </label>
                                        </div>
                                    ...
                                    <div class="mb-3 group-catatan">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <label for="dampak-tolak" class="input-group-text">
                                                <input type="radio" id="dampak-tolak" name="status_dampak"
                                                    value="Ditolak" class="d-none" />
                                                <i class="bi bi-x-circle-fill"></i>
                                            </label>
                                        </div>
                                    ...
                                    <div class="mb-3 group-catatan">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                value="{{ $pelaporan->dokumentasi }}" readonly />
