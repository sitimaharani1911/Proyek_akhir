                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        <li class="breadcrumb-item text-muted">
                            <a class="text-muted text-hover-primary">Monev</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted">
                            <a class="text-muted text-hover-primary">Detail Dokumen</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                        </li>
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Dokumen Informasi Hibah</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                        ...
                        <div class="form">
                            ...
                            <div class="d-flex mb-8 fv-row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <a href="{{ asset('storage/' . $document->kontrak) }}" target="_blank"
                                        class="text-primary">
                            ...
                            <div class="d-flex mb-8 fv-row">
                                ...
                                <div class="col-md-7">
                                    <i class="bi bi-file-earmark-pdf"></i>
                                    <a href="{{ asset('storage/' . $document->berita_acara) }}" target="_blank"
                                        class="text-primary">
                                        <span class="fw-semibold">Open </span>
                                    </a>
                                </div>
                            ...
                            <div class="d-flex mb-8 fv-row">
                                ...
                                <div class="col-md-7">
                                    <i class="bi bi-file-earmark-pdf"></i>
                                    <a href="{{ asset('storage/' . $document->verifikasi_kelayakan) }}" target="_blank"
                                        class="text-primary">
                                        <span class="fw-semibold">Open </span>
                                    </a>
                                </div>
                            ...
                            <div class="d-flex mb-8 fv-row">
                                ...
                                <div class="col-md-7">
                                    <i class="bi bi-file-earmark-pdf"></i>
                                    <a href="{{ asset('storage/' . $document->kerangka_acuan_kerja) }}" target="_blank"
                                        class="text-primary">
                                        <span class="fw-semibold">Open </span>
                                    </a>
                                </div>
                            ...
                            <div class="d-flex mb-8 fv-row">
                                ...
                                <div class="col-md-7">
                                    <i class="bi bi-file-earmark-pdf"></i>
                                    <a href="{{ asset('storage/' . $document->sk_tim_hibah) }}" target="_blank"
                                        class="text-primary">
                                        <span class="fw-semibold">Open </span>
                                    </a>
                                </div>
                    ...
                    @empty
                         <div class="alert alert-success">Dokumen Belum Diinputkan</div>
                    @endforelse
                </div>
            </div>
        </div>
