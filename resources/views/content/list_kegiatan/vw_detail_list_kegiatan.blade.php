            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('list-kegiatan.show', ['id' => encrypt($kegiatan->id)]) }}"
                    ...
                    <div class="card-body p-9">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row mb-4">
                                    <label class="col-md-4 fw-bold fs-6 text-gray-800">Surat Keputusan</label>
                                    <label class="col-md-1 fw-bold fs-6 text-gray-800">:</label>
                                    <div class="col-md-7">
                                        <i class="bi bi-file-earmark-pdf"></i>
                                        <a href="{{ asset('storage/' . $kegiatan->surat_keputusan) }}" target="_blank"
                                            class="text-primary">
