                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        <li class="breadcrumb-item text-muted">
                            <a class="text-muted text-hover-primary">Verifikasi
                                Monev</a>
                        </li>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Catatan Pimpinan</span>
                            </h3>
                        </div>
                        <div class="card-body py-3">
                            @if ($monevs)
                                @if ($pelaporan->review_pimpinan)
                                    <div class="alert alert-info">
                                        <strong>Sudah Di Review</strong>
                                        <p>{{ $pelaporan->review_pimpinan->catatan }}</p>
                                    </div>
                                @else
                                    <form class="form"
                                        action="{{ route('pimpinan.store', ['pelaporan_id' => $pelaporan->id]) }}"
